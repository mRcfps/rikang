    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(choices=[('R', '住院医师'), ('A', '主治医师'), ('D', '副主任医师'), ('C', '主任医师')], max_length=1, verbose_name='职称')),
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='手机号')),
            ],
            options={
